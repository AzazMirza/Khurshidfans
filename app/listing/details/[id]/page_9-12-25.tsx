...
//   if (loading) {
//     return (
//       <div className={`min-h-screen bg-[${theme.pr}] flex items-center justify-center`}>
//         <div className="text-center">
//           <div className="w-16 h-16 border-4 border-cyan-500 border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
//           <p className={`text-[${theme.tx}]`}>Loading product details...</p>
//         </div>
//       </div>
//     );
//   }
...
//           <p className={`text-[${theme.tx}] mb-6`}>
...
//   return (
//     <div className={`min-h-screen bg-[${theme.pr}] text-[${theme.tx}] overflow-hidden`}>
//       {/* Custom Cursor */}
//       <div
//         ref={cursorRef}
...
//       {/* Navigation */}
//       <nav className={`fixed top-0 w-full z-50 backdrop-blur-xl bg-[${theme.pr}]/50 border-b border-white/10`}>
...
//               <div className={`floating-product relative aspect-square bg-gradient-to-br from-gray-900 to-[${theme.pr}] rounded-3xl overflow-hidden border border-white/10 `}>
//                 <img
//                   // src={dimg}
...
//                   // priority
//                 />
//                 <div className={`absolute inset-0 bg-gradient-to-t from-[${theme.pr}]/40 via-transparent to-transparent`} />
//               </div>
...
//                 <div className="flex items-center space-x-4">
//                   <span className={`px-3 py-1 bg-[${theme.se}] text-[${theme.pr}] text-xs font-medium rounded-full border border-[${theme.se}]`}>
//                     Premium Collection
//                   </span>
...
//                       />
//                     ))}
//                     <span className={`ml-2 text-sm text-[${theme.tx}]`}>
//                       {product.rating.toFixed(1)} ({totalReviews} reviews)
//                     </span>
//                   </div>
//                 </div>

//                 <h1 className={`hero-text text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-[${theme.tx}]`}>
//                   {product.name}
//                 </h1>
...
//                   activeTab === tab
//                     ? `text-[${theme.pr}]`
//                     : `text-[${theme.tx}] hover:text-[${theme.tx}]-300`
//                 }`}
...
//                         <div className={`w-12 h-12 rounded-xl bg-[${theme.pr+33}] flex items-center justify-center mb-4 group-hover:bg-cyan-500/20 transition-colors`}>
...
//                         <h4 className={`text-[${theme.tx}] text-sm font-medium mb-1 capitalize`}>
...
//                 {/* Technical Diagram */}
//                 <div className={`mt-12 p-8 rounded-3xl bg-gradient-to-br from-gray-900 to-[${theme.pr}] border border-white/10`}>
...
//                             <span className={`w-12 text-[${theme.tx}]`}>
//                               {rating} stars
//                             </span>
...
//                             </div>
//                             <span className={`w-12 text-right text-[${theme.tx}]`}>
//                               {count}
//                             </span>
//                           </div>
//                         </div>
...
//                     </div>
//                     <button className={`px-6 py-3 bg-white text-[${theme.pr}] rounded-lg font-medium hover:bg-gray-200 transition-colors w-full sm:w-auto`}>
//                       Submit Review
//                     </button>
//                   </div>
//                 </div>
...
//                     />
//                     <div className={`absolute top-4 right-4 bg-[${theme.pr}]/70 backdrop-blur-sm text-[${theme.tx}] text-xs px-2.5 py-1.5 rounded-full flex items-center space-x-1`}>
//                       <Star className="w-3.5 h-3.5 text-yellow-400 fill-current" />
//                       <span className="font-semibold">{item.rating}</span>
//                     </div>
//                     <div className={`absolute inset-0 bg-gradient-to-t from-[${theme.pr}]/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
//                   </div>
...
//                       <button className={`px-4 py-2 bg-white text-[${theme.pr}] rounded-full text-sm font-semibold hover:bg-gray-200 transition-all opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0`}>
//                         View
//                       </button>
//                     </div>
//                   </div>
...
//             {/* <button className="px-8 py-4 bg-white text-[${theme.pr}] rounded-full font-bold text-lg hover:bg-gray-200 transition-all hover:scale-105 flex items-center justify-center">
...
//       {/* Footer */}
//       <footer className="border-t bg- border-white/10 py-16 px-4">
//         <div className="max-w-7xl mx-auto">
