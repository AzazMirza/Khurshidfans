...
// Apply free shipping if total quantity > 3
const shippingCost = totalQuantity > 3
  ? 0
  : selectedShipping === "express"
    ? 1000 * totalQuantity
    : 250 * totalQuantity;  // const tax = subtotal * 0.1; // 10% tax
  ...
  const removeFromCart = async (id: number) => {
    const idType = localStorage.getItem("userId")
      ? "userId"
      : localStorage.getItem("guestId")
      ? "guestId"
      : null;
    const storageId =
      localStorage.getItem("guestId") || localStorage.getItem("userId");
    console.log(idType, storageId);
    const res = await fetch(`/api/cart?id=${id}&${idType}=${storageId}`, {
      method: "DELETE",
      headers: {
...
// if (response.ok) {
    ...
    alert("Order Created Successfully. Order ID: " + ResponseData.order.id);
    if ( ResponseData.ok && ResponseData.order.paymentMethod === "credit") {
...
// const id = userId ? userId : guestId;
  ...
  return (
    <div
      ...
      style={{ color: theme.tx, backgroundColor: theme.bg }}
    >
      {/* Custom Cursor */}
      <div
        ref={cursorRef}
      ...
      style={{backgroundColor:theme.bg+80, borderColor:theme.tx}}>
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link
                ...
                <span className="font-medium " style={{color:theme.tx}}>Cart ({cartItems.length})</span>
              </Link>
            </div>
          </div>
        </div>
                      ...
                      <div className="space-y-4">
                        {cartItems.map((item, i) => (
                          <div
                            ...
                            className="flex items-center p-3 bg-white/5 rounded-2xl border border-white/10 hover:border-white/30 transition-all group"
                          ...
                          >
                            ...
                            <div className="flex flex-col justify-evenly w-full sm:flex-row text-white">
                              ...
                              <div className="flex items-center space-x-4">
                                ...
                                {/* <div className="flex items-center border border-white/20 rounded-full overflow-hidden">
                                  ...
                                  <span
                                    className="w-12 text-center py-2 font-medium"
    ...
    Empty Cart
              ...
              {step === "shipping" && (
                <div ref={setStepRef(1)} className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        style={{
                          borderColor:
                            isFocused == "Name" ? theme.pr : theme.tx, // or use a different default
                          outline: "none",
                          boxShadow:
                            isFocused == "Name"
                              ? `0px 0px 3px 1px ${theme.pr}`
                              : "none",
                        }}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        style={{
                          borderColor:
                            isFocused == "Last Name" ? theme.pr : theme.tx, // or use a different default
                          outline: "none",
                          boxShadow:
                            isFocused == "Last Name"
                              ? `0px 0px 3px 1px ${theme.pr}`
                    ...
                    <div>
                      ...
                      <input
                        ...
                        style={{
                          borderColor: isFocused == "tel" ? theme.pr : theme.tx, // or use a different default
                          outline: "none",
                          boxShadow:
                            isFocused == "tel"
                              ? `0px 0px 3px 1px ${theme.pr}`
                    ...
                    <div>
                      ...
                      <input
                        style={{
                          borderColor:
                            isFocused == "Email" ? theme.pr : theme.tx, // or use a different default
                          outline: "none",
                          boxShadow:
                            isFocused == "Email"
                              ? `0px 0px 3px 1px ${theme.pr}`
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        style={{
                          borderColor:
                            isFocused == "street" ? theme.pr : theme.tx, // or use a different default
                          outline: "none",
                          boxShadow:
                            isFocused == "street"
                              ? `0px 0px 3px 1px ${theme.pr}`
                    ...
                    <div>
                      ...
                      <input
                        ...
                        style={{
                          borderColor:
                            isFocused == "city" ? theme.pr : theme.tx, // or use a different default
                          outline: "none",
                          boxShadow:
                            isFocused == "city"
                              ? `0px 0px 3px 1px ${theme.pr}`
                    ...
                    <div>
                      ...
                      <input
                        ...
                        style={{
                          borderColor:
                            isFocused == "stateProvince" ? theme.pr : theme.tx, // or use a different default
                          outline: "none",
                          boxShadow:
                            isFocused == "stateProvince"
                              ? `0px 0px 3px 1px ${theme.pr}`
                              : "none",
                        }}
                        onFocus={() => setIsFocused("stateProvince")}
                        onBlur={() => setIsFocused("")}
                        className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-lg focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        style={{
                          borderColor: isFocused == "zip" ? theme.pr : theme.tx, // or use a different default
                          outline: "none",
                          boxShadow:
                            isFocused == "zip"
                              ? `0px 0px 3px 1px ${theme.pr}`
                    ...
                    <div>
                      ...
                      <input
                        ...
                        style={{
                          borderColor:
                            isFocused == "country" ? theme.pr : theme.tx, // or use a different default
                          outline: "none",
                          boxShadow:
                            isFocused == "country"
                              ? `0px 0px 3px 1px ${theme.pr}`
                  ...
                  <div className="space-y-4">
                    <h2 className="text-xl font-bold">Shipping Type</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {shippingOptions.map((option) => (
                        <div
                          key={option.id}
                          className={`p-6 rounded-2xl  transition-all cursor-pointer border-2  ${
                            option.id !== "standard" ? "cursor-not-allowed opacity-50" : ""
                          } `}
                          style={{
                            borderColor:
                          ...
                          onClick={() => option.id === "standard" && setSelectedShipping(option.id)}
                        >
                          ...
                          <p className=" text-sm">{option.estimatedDays}</p>
                          {selectedShipping === option.id && (
                            <div
                              className="w-4 h-4 rounded-full mt-3"
                              style={{ backgroundColor: theme.se }}
                            ></div>
                          )}
                        </div>
                      ))}
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <button
                      onClick={handleBack}
                      className="flex-1 flex items-center justify-center px-8 py-4 border-2 rounded-full font-semibold hover:bg-white/10 transition-all"
                      style={{ borderColor: theme.tx }}
                    >
                    ...
                    {/* <button
                      onClick={handleNext}
                      className="flex-1 border-2 text-black px-8 py-4 rounded-full font-semibold hover:bg-gray-200 transition-all flex items-center justify-center"
                      style={{borderColor:theme.se, backgroundColor:theme.pr+80, color:theme.tx}}>
                      <span>Continue to Payment</span>
                      <ChevronRight className="w-5 h-5 ml-2" />
                    </button> */}
                    <button
                      onClick={handleNext}
                      disabled={!isShippingFormValid()} // ←←← ADD THIS
                      className={`flex-1 border-2 px-8 py-4 rounded-full font-semibold flex items-center justify-center transition-all ${
                        !isShippingFormValid()
                      ...
                      style={{
                        borderColor: theme.se,
                        backgroundColor: isShippingFormValid()
                          ? theme.pr + "80"
                          : theme.pr + "40", // optional: dim background when disabled
                        color: theme.tx,
                      }}
                    >
                      <span>Continue to Payment</span>
                ...
                <div ref={setStepRef(2)} className="space-y-8">
                  ...
                  <div className="space-y-6">
                    ...
                    {selectedPayment === "cash" && (
                      <div className="space-y-6">
                        ...
                        <p className="text-sm">
                          Please make sure you have enough cash to cover the
                    ...
                    {selectedPayment === "bankTransfer" && (
                      <div className="space-y-6">
                        ...
                        <h4>
                          Bank Account Number:{" "}
                          <b> PK39 BAHL 5516 0115 0075 7701 7 </b>
                        </h4>
                        <p className="text-sm">
                          Please transfer the total amount in our bank account
                    ...
                    {selectedPayment === "credit" && (
                      <>
                        ...
                        <div className="p-6 bg-linear-to-r from-cyan-600/20 to-purple-600/20 rounded-2xl border border-cyan-500/30">
                          ...
                          <p className=" text-sm" style={{ color: theme.tx }}>
                            Your payment information is encrypted and secure. We
                            use industry-standard SSL encryption to protect your
                            data.
                          </p>
                        </div>
                      </>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <button
                      ...
                      className="flex-1 border-2 px-8 py-4 rounded-full font-semibold hover:bg-gray-200 transition-all flex items-center justify-center disabled:opacity-70"
                      style={{
                        borderColor: theme.se,
                        backgroundColor: theme.pr + 80,
                        color: theme.tx,
                ...
                <div ref={setStepRef(3)} className="space-y-8 text-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <button
                      ...
                      className="px-8 py-4 border-2 border-black rounded-full font-semibold hover:bg-white/10 transition-all"
                    >
                      Continue Shopping
                    </button>
            ...
            <div className="space-y-6">
              <div className="p-6 bg-white/5 rounded-2xl border border-white/10">
                ...
                <div className="border-t border-white/20 pt-4 space-y-3">
                  <div className="flex justify-between">
                    <span className="text-gray-400" style={{ color: theme.tx }}>
                      Subtotal
                    </span>
              ...
              {/* Security Badges */}
              <div
                className="p-6 bg-linear-to-br from-gray-900 to-black rounded-2xl border border-white/10"
                style={{ color: theme.bg }}
              >
                <h3 className="font-bold mb-4" style={{ color: theme.bg }}>
                  Secure Shopping
                </h3>
