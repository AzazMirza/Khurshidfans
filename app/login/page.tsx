...
const Login02Page = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md flex flex-col items-center px-8 py-10 rounded-2xl shadow-lg backdrop-blur-lg bg-(--nav-color)/20 border border-white/70">
        <img
        ...
        <Form {...form}>
          ...
          >
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        className="w-full bg-white/10 border border-white/40 text-white placeholder-white/70"
                        {...field}
                      />
                    </FormControl>
            ...
            <Button
              type="submit"
              className="mt-4 w-full bg-(--gold-btn-color) hover:bg-(--gold-btn-hover) text-black cursor-pointer"
            >
              Continue
            </Button>
          </form>
        ...
        <div className="mt-5 space-y-5">
          <Link
            href="#"
            className="text-sm block underline text-white/80 text-center hover:text-(--gold-btn-color)"
          >
          ...
          <p className="text-sm text-center text-white/80">
            ...
            <Link
              href="/signup"
              className="ml-1 underline text-white/80 hover:text-(--gold-btn-color)"
            >
              Create account
            </Link>
          </p>
