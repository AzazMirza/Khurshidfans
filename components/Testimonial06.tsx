...
const Testimonial06 = () => {
  ...
  return (
    ...
    <div className="relative z-10  bg-[#009395] min-h-screen w-full flex justify-center items-center py-4 px-6">
      <div className="w-full">
        <h2 className="text-3xl xs:text-3xl md:text-4xl font-bold text-white text-center tracking-[-0.03em]">
          Testimonials
        </h2>
        <p className="mt-3 text-center text-white text-xl">
          See what our users have to say about us
        </p>
        <div className="mt-16 container w-full lg:max-w-(--breakpoint-lg) xl:max-w-(--breakpoint-xl) mx-auto px-12">
...
const TestimonialCard = ({
  ...
  <div className="mb-8 border  bg-[#009395] rounded-xl py-8 px-6 sm:py-6 {/*shadow-[0_0_10px_rgba(223,211,0,0.5)]*/}">
