      ...
      <div className="relative z-10 px-6 py-20 ">
        <motion.div
          ...
          className="relative w-full text-foreground max-w-screen-lg mx-auto rounded-2xl py-10 md:py-16 px-6 lg:px-14 
                      bg-[#009395] dark:bg-black/20 backdrop-blur-lg shadow-xl border border-white"
        >
          {/* Heading + Text */}
          ...
          {/* Buttons */}
            <Link
              href="catalogue"
              className="mt-10 mx-auto flex flex-col sm:flex-row gap-4 items-center"
              // className="inline-flex items-center gap-2 rounded-lg bg-[var(--gold-btn-color)] text-black font-medium px-5 py-2 transition hover:bg-[var(--gold-btn-hover)]"
            >
              
            <Button
              size="lg"
              className="bg-[var(--gold-btn-color)]  mx-auto text-black hover:bg-[var(--gold-btn-hover)] cursor-pointer"
            >
